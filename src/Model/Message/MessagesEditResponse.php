...
/**
 * MessagesEditResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesEditResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_edit_response';
    ...
    public const RESPONSE_0 = 0;
    public const RESPONSE_1 = 1;
    ...
    */
     ...
     * Sets response
     *
     * @param int|null $response Result
     *
     * @return self
     */
