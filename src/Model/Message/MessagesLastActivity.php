...
/**
 * MessagesLastActivity Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesLastActivity implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_last_activity';
    ...
    */
     ...
     * Sets online
     *
     * @param int|null $online Information whether user is online
     *
     * @return self
     */
     ...
     * Sets time
     *
     * @param int|null $time Time when user was online in Unixtime
     *
     * @return self
     */
