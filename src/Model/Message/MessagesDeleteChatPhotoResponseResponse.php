<?php
/**
 * MessagesDeleteChatPhotoResponseResponse
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * MessagesDeleteChatPhotoResponseResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesDeleteChatPhotoResponseResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_deleteChatPhoto_response_response';
    ...
    */
     ...
     * Sets message_id
     *
     * @param int|null $message_id Service message ID
     *
     * @return self
     */
     ...
     * Sets chat
     *
     * @param MessagesChat|null $chat chat
     *
     * @return self
     */
