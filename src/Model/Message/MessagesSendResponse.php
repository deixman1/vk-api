...
/**
 * MessagesSendResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesSendResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_send_response';
    ...
    */
     ...
     * Sets response
     *
     * @param int|null $response Message ID
     *
     * @return self
     */
