...
/**
 * MessagesGetConversationByIdExtended Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesGetConversationByIdExtended implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_getConversationById_extended';
    ...
    */
    ...
    public function setCount($count)
    {
        ...
        if (!is_null($count) && ($count < 0)) {
            throw new InvalidArgumentException('invalid value for $count when calling MessagesGetConversationByIdExtended., must be bigger than or equal to 0.');
        }
