...
/**
 * MessagesChatPushSettings Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesChatPushSettings implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_chat_push_settings';
    ...
    public const SOUND_0 = 0;
    public const SOUND_1 = 1;
     ...
     * @return string[]
     */
    public function getSoundAllowableValues()
    {
        return [
            self::SOUND_0,
            self::SOUND_1,
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = $this->getSoundAllowableValues();
        if (!is_null($this->container['sound']) && !in_array($this->container['sound'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'sound', must be one of '%s'",
                $this->container['sound'],
     ...
     * Sets sound
     *
     * @param int|null $sound Information whether the sound is on
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getSoundAllowableValues();
        if (!is_null($sound) && !in_array($sound, $allowedValues, true)) {
