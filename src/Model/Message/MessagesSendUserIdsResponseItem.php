...
/**
 * MessagesSendUserIdsResponseItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesSendUserIdsResponseItem implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_send_user_ids_response_item';
    ...
    protected static $openAPITypes = [
        ...
        'error' => '\OpenAPI\Client\Model\BaseMessageError'
    ];
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['message_id']) && ($this->container['message_id'] < 0)) {
            $invalidProperties[] = "invalid value for 'message_id', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['conversation_message_id']) && ($this->container['conversation_message_id'] < 0)) {
            $invalidProperties[] = "invalid value for 'conversation_message_id', must be bigger than or equal to 0.";
        }
     ...
     * Sets peer_id
     *
     * @param int|null $peer_id peer_id
     *
     * @return self
     */
    ...
    public function setMessageId($message_id)
    {
        ...
        if (!is_null($message_id) && ($message_id < 0)) {
            throw new InvalidArgumentException('invalid value for $message_id when calling MessagesSendUserIdsResponseItem., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param int|null $conversation_message_id conversation_message_id
     *
     * @return self
     */
    public function setConversationMessageId($conversation_message_id)
    {
        ...
        if (!is_null($conversation_message_id) && ($conversation_message_id < 0)) {
            throw new InvalidArgumentException('invalid value for $conversation_message_id when calling MessagesSendUserIdsResponseItem., must be bigger than or equal to 0.');
        }
     ...
     * Gets error
     *
     * @return OpenAPI\Client\Model\BaseMessageError|null
     */
     ...
     * Sets error
     *
     * @param OpenAPI\Client\Model\BaseMessageError|null $error error
     *
     * @return self
     */
