...
/**
 * MessagesConversationSortId Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesConversationSortId implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_conversation_sort_id';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('minor_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets major_id
     *
     * @param int|null $major_id Major id for sorting conversations
     *
     * @return self
     */
    public function setMajorId($major_id)
    {
        ...
        if (!is_null($major_id) && ($major_id < 0)) {
            throw new InvalidArgumentException('invalid value for $major_id when calling MessagesConversationSortId., must be bigger than or equal to 0.');
        }
     ...
     * Sets minor_id
     *
     * @param int|null $minor_id Minor id for sorting conversations
     *
     * @return self
     */
    public function setMinorId($minor_id)
    {
        ...
        if (!is_null($minor_id) && ($minor_id < 0)) {
            throw new InvalidArgumentException('invalid value for $minor_id when calling MessagesConversationSortId., must be bigger than or equal to 0.');
        }


        if (is_null($minor_id)) {
            throw new InvalidArgumentException('non-nullable minor_id cannot be null');
        }
