...
/**
 * MessagesGetLastActivityResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesGetLastActivityResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_getLastActivity_response';
    ...
    */
     ...
     * Gets response
     *
     * @return MessagesLastActivity|null
     */
     ...
     * Sets response
     *
     * @param MessagesLastActivity|null $response response
     *
     * @return self
     */
