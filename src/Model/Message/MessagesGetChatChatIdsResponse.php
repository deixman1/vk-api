...
/**
 * MessagesGetChatChatIdsResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesGetChatChatIdsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_getChat_chat_ids_response';
    ...
    */
     ...
     * Sets response
     *
     * @param MessagesChat[]|null $response response
     *
     * @return self
     */
