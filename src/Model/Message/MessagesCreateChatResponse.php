...
/**
 * MessagesCreateChatResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesCreateChatResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_createChat_response';
    ...
    */
     ...
     * Sets response
     *
     * @param int|null $response Chat ID
     *
     * @return self
     */
