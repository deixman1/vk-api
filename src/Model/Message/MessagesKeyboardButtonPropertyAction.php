...
/**
 * MessagesKeyboardButtonPropertyAction Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesKeyboardButtonPropertyAction implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_keyboard_button_property_action';
    ...
    */
     ...
     * Sets app_id
     *
     * @param int|null $app_id Fragment value in app link like vk.com/app{app_id}_-654321#hash
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label Label for button
     *
     * @return self
     */
     ...
     * Sets owner_id
     *
     * @param int|null $owner_id Fragment value in app link like vk.com/app123456_{owner_id}#hash
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link link for button
     *
     * @return self
     */
