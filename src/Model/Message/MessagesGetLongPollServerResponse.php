...
/**
 * MessagesGetLongPollServerResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesGetLongPollServerResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_getLongPollServer_response';
    ...
    */
     ...
     * Sets response
     *
     * @param MessagesLongpollParams|null $response response
     *
     * @return self
     */
