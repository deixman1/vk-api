<?php
/**
 * MessagesGetByConversationMessageIdExtendedResponseResponse
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * MessagesGetByConversationMessageIdExtendedResponseResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesGetByConversationMessageIdExtendedResponseResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_getByConversationMessageId_extended_response_response';
    ...
    */
     ...
     * Sets items
     *
     * @param MessagesMessage[]|null $items items
     *
     * @return self
     */
