<?php
/**
 * MessagesGetHistoryAttachmentsResponseResponse
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * MessagesGetHistoryAttachmentsResponseResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagesGetHistoryAttachmentsResponseResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'messages_getHistoryAttachments_response_response';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('next_from', $data ?? [], null);
    ...
    */
     ...
     * Gets items
     *
     * @return MessagesHistoryAttachment[]|null
     */
     ...
     * Sets items
     *
     * @param MessagesHistoryAttachment[]|null $items items
     *
     * @return self
     */
     ...
     * Sets next_from
     *
     * @param string|null $next_from Value for pagination
     *
     * @return self
     */
    public function setNextFrom($next_from)
    {
        ...
        if (is_null($next_from)) {
            throw new InvalidArgumentException('non-nullable next_from cannot be null');
        }
